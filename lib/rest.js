...
class BinanceRest {
    ...
    _makeRequest(query, callback, route, security, method, attempt = 0) {
        ...
        const type = _.last(route.split('/')),
            options = {
                url: `${route.substring(0,4) === 'fapi' ? 'https://fapi.binance.com/' : 'https://api.binance.com/'}${route}`,
    ...
    allOrdersNS(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/allOrders', 'SIGNED');
    }
    ...
    assetDetails(callback) {
        const query = {};
        this._setTimestamp(query);
        return this._makeRequest(query, callback, '/wapi/v3/assetDetail.html', 'SIGNED');
    }
    ...
    keepAliveUserDataStreamMargin(query = {}, callback) {
        return this._makeRequest(query, callback, 'sapi/v1/userDataStream', 'API-KEY', 'PUT');
    }
    ...
    startUserDataStreamMargin(callback) {
        return this._makeRequest({}, callback, 'sapi/v1/userDataStream', 'API-KEY', 'POST');
    }

    newOrderMargin(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/order', 'SIGNED', 'POST');
    }

    accountMargin(query = {}, callback) {
        if (_.isFunction(query)) {
            callback = query;
            query = {};
        }
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/account', 'SIGNED');
    }

    marginBorrow(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/loan', 'SIGNED', 'POST');
    }

    marginRepay(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/repay', 'SIGNED', 'POST');
    }

    marginTransfer(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/transfer', 'SIGNED', 'POST');
    }

    marginopenOrders(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/openOrders', 'SIGNED');
    }

    marginForceLiquidRecs(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/margin/forceLiquidationRec', 'SIGNED');
    }
    //Daily Account Snapshot
    accountSnapshot(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'sapi/v1/accountSnapshot', 'SIGNED','GET');
    }
    
    startUserDataStreamFutures(callback) {
        return this._makeRequest({}, callback, 'fapi/v1/listenKey', 'API-KEY', 'POST');
    }

    keepAliveUserDataStreamFutures(query = {}, callback) {
        return this._makeRequest(query, callback, 'fapi/v1/listenKey', 'API-KEY', 'PUT');
    }

    balanceFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/balance', 'SIGNED');
    }
    
    balanceFuturesv2(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v2/balance', 'SIGNED');
    }
    
    positionRisk(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v2/positionRisk', 'SIGNED');
    }
    
    newOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/order', 'SIGNED', 'POST');
    }
    
    cancelOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/order', 'SIGNED', 'DELETE');
    }
    
    cancelMultipleFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/batchOrders', 'SIGNED', 'DELETE');
    }
    
    queryOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/order', 'SIGNED');
    }
    
    allOrdersFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/allOrders', 'SIGNED');
    }
    
    leverageFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/leverage', 'SIGNED', 'POST');
    }

    marginTypeFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/marginType', 'SIGNED', 'POST');
    }
    
    accountFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v2/account', 'SIGNED');
    }

    getIncomeFutures(query = {}, callback){
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'fapi/v1/income', 'SIGNED');
    }
}
